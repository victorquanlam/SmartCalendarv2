...
import { WeekDay, CalendarEvent, WeekViewAllDayEvent, WeekView, WeekViewHourColumn, DayViewEvent, DayViewHourSegment, DayViewHour, WeekViewAllDayEventRow } from 'calendar-utils';
...
export declare class CalendarWeekViewComponent implements OnChanges, OnInit, OnDestroy {
    ...
    protected getDragMovedEventTimes(weekEvent: WeekViewAllDayEvent | DayViewEvent, dragEndEvent: DragEndEvent | DragMoveEvent, dayWidth: number, useY: boolean): {
        start: Date;
        end: Date;
    };
